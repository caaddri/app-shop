...
<div class="main main-raised">
  <div class="container">
    ...
    <div class="section text-center">
      ...
      <form class="" action="" method="post" enctype="multipart/form-data"> <!--El action va sin nada por que la petición es hacia la misma ruta por lo que laravel lo asume-->
        {{ csrf_field() }}
